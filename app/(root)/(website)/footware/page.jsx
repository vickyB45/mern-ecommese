...
import { WEBSITE_FOOTWARES, WEBSITE_MEN_COLLECTION } from "@/routes/WebsiteRoute";
import ProductCard from "@/components/Aplication/website/ProductCart";

const breadCrumb = {
  title: "FootWare Collections",
  links: [
    {
      label: "Footwares",
...
const ManCategory = async () => {
  const category = "footware collection"; // Hardcoded category for now
